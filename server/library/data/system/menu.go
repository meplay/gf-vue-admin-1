...
var (
	...
	menus = []model.Menu{
		...
		{Model: global.Model{ID: 22, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "http://www.gf-vue-admin.com", Name: "http://www.gf-vue-admin.com", Hidden: false, Component: "/", Sort: 0, Meta: model.Meta{Title: "官方网站", Icon: "s-home"}},
