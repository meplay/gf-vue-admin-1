...
// arModel is a active record design model for table parameters  operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of parameters.
	Table = "parameters"
	// Model is the model object of parameters.
	Model = &arModel{g.DB(global.Db).Table(Table).Safe()}
	// Columns defines and stores column names for table parameters.
	Columns = struct {
		Id         string // 自增ID
