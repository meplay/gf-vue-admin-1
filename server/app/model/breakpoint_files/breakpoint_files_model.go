...
// arModel is a active record design model for table breakpoint_files operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of breakpoint_files.
	Table = "breakpoint_files"
	// Model is the model object of breakpoint_files.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table breakpoint_files.
	Columns = struct {
		Id          string // 自增ID    
