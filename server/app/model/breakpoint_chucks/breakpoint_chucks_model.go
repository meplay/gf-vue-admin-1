...
// arModel is a active record design model for table breakpoint_chucks operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of breakpoint_chucks.
	Table = "breakpoint_chucks"
	// Model is the model object of breakpoint_chucks.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table breakpoint_chucks.
	Columns = struct {
		Id               string // 自增ID    
