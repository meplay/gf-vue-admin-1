...
type AutoCodeHistory struct {
	...
	Request       string `json:"requestMeta" gorm:"column:request;comment:前端传入的结构化信息"`
	...
	Apis      AutoCodeApis        `json:"apis" gorm:"column:apis;comment:api表注册内容"`
	Injection []AutoCodeInjection `json:"injection" gorm:"column:injection;comment:注入的内容结构体"`
}
