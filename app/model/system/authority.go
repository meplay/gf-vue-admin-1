...
type Authority struct {
	...
	Resources     []Authority    `json:"dataAuthorityId" gorm:"many2many:system_authorities_resources;foreignKey:AuthorityId;joinForeignKey:AuthorityId;References:AuthorityId;JoinReferences:ResourcesId"`
}
